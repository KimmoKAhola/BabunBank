...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BabunBank.Data.Account", b =>
                {
            ...
            modelBuilder.Entity("BabunBank.Data.Card", b =>
                {
            ...
            modelBuilder.Entity("BabunBank.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("BabunBank.Data.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BabunBank.Data.Loan", b =>
                {
            ...
            modelBuilder.Entity("BabunBank.Data.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("BabunBank.Data.Transaction", b =>
                {
            ...
            modelBuilder.Entity("BabunBank.Data.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BabunBank.Data.Card", b =>
                {
                    b.HasOne("BabunBank.Data.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("BabunBank.Data.Disposition", b =>
                {
                    b.HasOne("BabunBank.Data.Account", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .IsRequired()
                        .HasConstraintName("FK_Dispositions_Accounts");

                    b.HasOne("BabunBank.Data.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("BabunBank.Data.Transaction", b =>
                {
                    b.HasOne("BabunBank.Data.Account", "AccountNavigation")
