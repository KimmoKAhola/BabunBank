...
namespace DataAccessLibrary.Migrations
{
    ...
    [Migration("20240403101252_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Account", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Card", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Loan", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Transaction", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.User", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Card", b =>
                {
                    b.HasOne("DataAccessLibrary.Data.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Disposition", b =>
                {
                    b.HasOne("DataAccessLibrary.Data.Account", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .IsRequired()
                        .HasConstraintName("FK_Dispositions_Accounts");

                    b.HasOne("DataAccessLibrary.Data.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("DataAccessLibrary.Data.Transaction", b =>
                {
                    b.HasOne("DataAccessLibrary.Data.Account", "AccountNavigation")
